...
const Footer = () => {
  ...
  <div className="w-full border-t border-gray-700 pt-4 text-center text-gray-400 text-sm">
    <p>
      ...
      Crafted with ❤️ by <a href="https://github.com/OishiSharmeen04" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Oishi Sharmeen</a>.  
      All rights reserved.
    </p>
  </div>
</footer>
